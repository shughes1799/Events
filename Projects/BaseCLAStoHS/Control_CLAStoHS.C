{
  //Set the input files
   ...
   tree->Add("~dglazier/Work/Research/HaSpect/data/pippippimMn/inp*_50.root");
   ...
   gSystem->Setenv("HSOUT",
		   "/home/dglazier/Work/Research/HaSpect/data/pippippimMn_HS4/test.root");
   
   //Configure the analysis (i.e PROOF, source compilation...)
   TString HSANA("/home/dglazier/Dropbox/HaSpect/Analysis/HaSpect/");
